...
| | |
| :--- | :--- |
| *Official URL*:https://standards.digital.health.nz/ns/alias-type-code | *Version*:2.0.0 |
| Active as of 2023-10-25 | *Computable Name*:AliasType |
...
* [AliasType](ValueSet-org-and-location-alias-type.md)
...
```json
{
  ...
  "meta" : {
    "versionId" : "9",
    "lastUpdated" : "2026-05-07T20:10:43.324+12:00",
    "tag" : [{
